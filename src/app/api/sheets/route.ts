...
export async function GET(req: NextRequest) {
  try {
    ...
    const lead = {
      ...
      Lead_Type: (metadataObj as any)?.lead_type || (metadataObj as any)?.Lead_Type || (metadataObj as any)?.category || data.lead_type || '',
      lead_type: (metadataObj as any)?.lead_type || (metadataObj as any)?.category || data.lead_type || '',
